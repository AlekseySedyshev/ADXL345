...
delay_ms (200);	
LCD_Init();LCD_Clear();
LCD_Gotoxy (5,0);LCD_PrintStr(" TEST ADXL345 ",1);
ADXL345_Init();
...
/*	 
	...
	*/ 
LCD_Gotoxy (1,2);LCD_PrintStr("aX ",0);LCD_PrintDec((int16_t)XA,0);LCD_PrintStr("    ",0); 
LCD_Gotoxy (1,3);LCD_PrintStr("aY ",0);LCD_PrintDec((int16_t)YA,0);LCD_PrintStr("    ",0); 
LCD_Gotoxy (1,4);LCD_PrintStr("aZ ",0);LCD_PrintDec((int16_t)ZA,0);LCD_PrintStr("    ",0); 

LCD_Gotoxy (1,5);LCD_PrintStr("BW_Rate   ",0);LCD_PrintBin(readReg8(ADXL345_BW_RATE),0);LCD_PrintStr("  ",0);
LCD_Gotoxy (1,6);LCD_PrintStr("Pow_CTL   ",0);LCD_PrintBin(readReg8(ADXL345_POWER_CTL),0);LCD_PrintStr("  ",0);
LCD_Gotoxy (1,7);LCD_PrintStr("Data Form ",0);LCD_PrintBin(readReg8(ADXL345_DATA_FORMAT),0);LCD_PrintStr("  ",0); 
